...
struct RoomCreatedView: View {
    @State private var path = NavigationPath() // ⬅️ مسار التنقل بدون زر رجوع
            ...
            ZStack {
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 24) {
                        ...
                        Button(action: {
                            path.append("gameRoom") // ⬅️ التنقل إلى الصفحة الأخيرة
                        }) {
                            Text("ابدأ")
                                .foregroundColor(.white)
                                .bold()
            ...
            .navigationDestination(for: String.self) { value in
                if value == "gameRoom" {
                    GameRoom2(viewModel: ActionCardViewModel())
                        .navigationBarBackButtonHidden(true) // ⬅️ لا رجوع
                }
            }
        }
    }
